...
- Portfolio Website: <br/>
  ...
  As I had been wanting to learn React, I thought it would be a perfect opportunity to create a portfolio website as a personal project. After doing various tutorials, I began creating my portfolio project with create-react-app. First, I had built most of the HTML elements and page contents within various page components, then began applying my new learnings in React. I began with linking of the pages and components, then began to apply hooks and internal properties to update components within the page, such as toggling gifs, hiding resume content, and filtering portfolio items based on a general project-type (similar to how the menu-items for the coding exercise were filtered, but only filtered data would be rendered).

  - After deploying onto GitHub Pages, I noticed that singe page applications do not work well on refresh of the page. I adjusted an online solution to cater it specifically for my project, where I can redirect error pages to the relevant single page link while also being able to redirect the user to external pages (such as downloading resume).
